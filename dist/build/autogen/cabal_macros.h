...
/* package spacecat-0.1.1.0 */
#define VERSION_spacecat "0.1.1.0"
#define MIN_VERSION_spacecat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "spacecat-0.1.1.0"

#define CURRENT_PACKAGE_KEY "spacecat-0.1.1.0"

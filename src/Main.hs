...
main :: IO ()
main = do
    catR <- loadBMP "graphics/cat_r.bmp"
    catL <- loadBMP "graphics/cat_l.bmp"
    swipeR <- loadBMP "graphics/cat_swipe_r.bmp"
    swipeL <- loadBMP "graphics/cat_swipe_l.bmp"
    life <- loadBMP "graphics/life_img.bmp"
    platHard <- loadBMP "graphics/plat_hard_bot_sym.bmp"
    platSoft <- loadBMP "graphics/plat_soft_bot.bmp"
    gate <- loadBMP "graphics/gate.bmp"
    ground <- loadBMP "graphics/metal_floor.bmp"
    cannonL <- loadBMP "graphics/cannon_l.bmp"
    cannonR <- loadBMP "graphics/cannon_r.bmp"
    cannonU <- loadBMP "graphics/cannon_u.bmp"
    cannonD <- loadBMP "graphics/cannon_d.bmp"
    spikeImg <- loadBMP "graphics/spikes.bmp"
    bgImg <- loadBMP "graphics/m16_lr_crop.bmp"
    healthBarImg <- loadBMP "graphics/healthbar.bmp"
    healthImg <- loadBMP "graphics/health.bmp"
    failedImg <- loadBMP "graphics/failed.bmp"
    successImg <- loadBMP "graphics/complete.bmp"
    homeBgImg <- loadBMP "graphics/home_bg.bmp"
    titleImg <- loadBMP "graphics/title_v1.1.bmp"
    map1Img <- loadBMP "graphics/map1_img.bmp"
    map2Img <- loadBMP "graphics/map2_img.bmp"
    homeImg <- loadBMP "graphics/home_button.bmp"
    retryImg <- loadBMP "graphics/retry_button.bmp"
    oneInfo <- loadBMP "graphics/map1_label.bmp"
    twoInfo <- loadBMP "graphics/map2_label.bmp"
